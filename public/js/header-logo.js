...
(() => {
    ...
    const changeLogo = (theme) => {
        ...
        if (logo) {
            if (theme === "dark") {
                logo.srcset = logo.srcset.replace("cartes-gouv-logo.svg", "cartes-gouv-logo-dark.svg");
            } else {
                logo.srcset = logo.srcset.replace("cartes-gouv-logo-dark.svg", "cartes-gouv-logo.svg");
            }
        }
    };
