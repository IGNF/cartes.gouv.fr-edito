...
Si vous constatez un incident lors de l’utilisation de la Géoplateforme, vous pouvez adresser un message via la rubrique&nbsp;: [Nous écrire | cartes.gouv.fr](/aide/fr/nous-ecrire).
...
Vous pouvez signaler toute difficulté à tout moment en faisant expressément la demande à l’IGN par écrit au support utilisateur joignable via la rubrique&nbsp;: [Nous écrire | cartes.gouv.fr](/aide/fr/nous-ecrire).
...
La dénomination des API est susceptible d’évoluer&nbsp;: il convient de se référer au [Catalogue | cartes.gouv.fr](/rechercher-une-donnee).
